...
function travel_node( document, elm , current_dist, current_rank , total_ranks , direction , tag )
{
 ...
 else return -1 // terminate and don't count this node (it gets added by the previous travel_edge on call stack)
}
...
window.onload = function() { execute_keyboard_function( document, "v" ) }
