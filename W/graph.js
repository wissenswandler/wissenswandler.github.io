...
function travel( id, event )
{
 ...
 console.log( "counted " + temp + " nodes" )
 temp = 0
...
function start_travel( id , mdn , direction )
{
 ...
 console.log( "travelled " + temp + " nodes" )
}
...
{
 ++temp
 if(  set_visitor_tags( id , current_dist , total_ranks , direction , tag )  )
 {
...
function set_visitor_tags( id , current_dist , total_ranks , direction , tag )
{
 ...
 var tag2   = svgElm.getAttribute( "tag2" )
 ...
 if( tag1 == null )	{ svgElm.setAttribute( "tag1", tag ) }
 else			{ svgElm.setAttribute( "tag2", tag ) }
...
window.addEventListener("keydown", function (event) {
  ...
  if (event.key !== undefined)
  {
    ...
    {
      console.log( "[D]im ALL EXCEPT selected nodes" )
